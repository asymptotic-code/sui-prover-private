...
#[mode(spec), ext(spec(target = sui::accumulator::emit_deposit_event))]
...
#[mode(spec), ext(spec(target = sui::accumulator::emit_withdraw_event))]
...
#[mode(spec), ext(spec(target = sui::accumulator::accumulator_address))]
