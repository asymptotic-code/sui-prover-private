...
#[mode(spec), ext(spec_only(include(a = 0x42::foo_specs, b = 0x42::bar_specs)))]
module 0x42::foobar_specs_1 {
  use prover::prover::ensures;
  use 0x42::fb::foobar;

  #[mode(spec), ext(spec(prove, target = 0x42::fb::foobar))]
...
#[mode(spec), ext(spec_only(include(a = 0x42::foo_specs::foo_spec, b = 0x42::bar_specs::bar_spec)))]
