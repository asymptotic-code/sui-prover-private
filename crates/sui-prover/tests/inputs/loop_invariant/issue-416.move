...
#[mode(spec), ext(spec_only(loop_inv(target=bar)), pure)]
...
#[mode(spec), ext(spec(prove, boogie_opt=b"vcsMaxKeepGoingSplits:2 vcsSplitOnEveryAssert vcsFinalAssertTimeout:600"))]
